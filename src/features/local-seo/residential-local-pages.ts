...
const pages: ResidentialLocalPageContent[] = [
    {
        ...
        metaDescription: localized('ARTIDOM makes custom kitchens, wardrobes and apartment furniture in Bar. Local measurement, delivery and installation from the workshop.', 'ARTIDOM radi kuhinje po mjeri, plakare i opremanje apartmana u Baru. Lokalno mjerenje, isporuka i montaža iz radionice.', 'ARTIDOM производит кухни на заказ, шкафы и мебель для квартир в Баре. Замер, доставка и монтаж из собственного цеха.'),
    ...
    },
    {
        ...
        metaDescription: localized('ARTIDOM furnishes Budva apartments and rental properties with custom kitchens, wardrobes and built-in storage made in Zaljevo, Bar.', 'ARTIDOM oprema apartmane i stanove za izdavanje u Budvi: kuhinje po mjeri, plakari i ugradno odlaganje iz radionice u Zaljevu, Bar.', 'ARTIDOM меблирует квартиры и арендное жильё в Будве: кухни на заказ, шкафы и встроенное хранение из цеха в Залево (Бар).'),
