...
const pricingFaqs: FAQItem[] = [
    ...
    },
    {
        ...
        answer: localized('Overall dimensions, front material, fittings, worktop type, integrated appliances and installation complexity.', 'Ukupne dimenzije, materijal frontova, okovi, tip radne ploče, ugradna tehnika i složenost montaže.', 'Габариты, материал фасадов, фурнитура, тип столешницы, встроенная техника и сложность монтажа.'),
    },
    {
    ...
    {
        question: localized('What affects timing after approval?', 'Šta utiče na rok nakon odobrenja?', 'Что влияет на срок после согласования?'),
        answer: localized('Timing depends on measurements, materials, project scope and installation access after details are confirmed.', 'Rok zavisi od mjera, materijala, obima projekta i pristupa za montažu nakon potvrde detalja.', 'Срок зависит от замеров, материалов, объёма проекта и доступа для монтажа после подтверждения деталей.'),
    },
];
...
const pages: ResidentialLocalPageContent[] = [
    {
        ...
        metaTitle: localized('Custom furniture and kitchens in Bar, Montenegro', 'Kuhinje po mjeri Bar Crna Gora | Namještaj po mjeri Bar', 'Мебель и кухни на заказ в Баре, Черногория'),
        metaDescription: localized('ARTIDOM makes custom kitchens, wardrobes and apartment furniture in Bar. Local measurement, delivery and installation from the workshop.', 'Izrada namještaja po mjeri Bar: kuhinje po mjeri, plakari i opremanje apartmana. Mjerenje, proizvodnja i montaža iz radionice u Zaljevu.', 'ARTIDOM производит кухни на заказ, шкафы и мебель для квартир в Баре. Замер, доставка и монтаж из собственного цеха.'),
        label: localized('Bar, Montenegro', 'Bar, Crna Gora', 'Бар, Черногория'),
        title: localized('Custom kitchens and apartment furniture in Bar', 'Kuhinje po mjeri Bar i namještaj po mjeri Bar', 'Кухни на заказ и мебель для квартир в Баре'),
        intro: localized('Bar is the shortest route from the workshop to the apartment. This page targets owners, investors and rental properties that need a kitchen, wardrobes or a full furnishing package without extra logistics.', 'Kuhinje po mjeri Bar Crna Gora traže precizno mjerenje, dobar raspored i montažu bez dodatne logistike. Stranica je za vlasnike, investitore i apartmane za izdavanje kojima trebaju kuhinja, plakari ili kompletan paket.', 'Бар — кратчайший маршрут от цеха до квартиры. Страница для владельцев, инвесторов и арендного жилья, которым нужна кухня, шкафы или полный пакет меблировки без лишней логистики.'),
        ...
        processItems: [
            ...
            localized('Short delivery chain from Zaljevo to site', 'Kratak lanac isporuke od Zaljeva do objekta', 'Короткая цепочка доставки от Залево до объекта'),
        ],
        note: localized('The workshop is in Zaljevo (Bar), so Bar jobs are the easiest to coordinate for repeated site visits, corrections and final installation.', 'Radionica je u Zaljevu (Bar), pa su poslovi u Baru najjednostavniji za koordinaciju, dodatna mjerenja i završnu montažu.', 'Цех в Залево (Бар), поэтому заказы в Баре проще всего координировать: повторные выезды, корректировки и финальный монтаж.'),
    ...
    },
    {
        ...
        metaTitle: localized('Custom kitchens and apartment furnishing in Podgorica', 'Kuhinje po mjeri Podgorica | Namještaj po mjeri Podgorica', 'Кухни на заказ и меблировка квартир в Подгорице'),
        metaDescription: localized('ARTIDOM works with Podgorica apartments, new developments and villas: custom kitchens, wardrobes and full furnishing packages with installation.', 'Izrada namještaja po mjeri za Podgoricu: kuhinje po mjeri, plakari i kompletni paketi za stanove, novogradnju i vile sa montažom.', 'ARTIDOM работает с квартирами, новостройками и виллами в Подгорице: кухни на заказ, шкафы и полные пакеты меблировки с монтажом.'),
        ...
        note: localized('For Podgorica, the advantage is not speed alone but full package coordination: cleaner handover and a more consistent finish language.', 'Za Podgoricu prednost nije samo brzina nego i koordinacija cijelog paketa: čistija primopredaja i ujednačeniji finiši.', 'В Подгорице преимущество не только в скорости, но и в координации всего пакета: чистая сдача и единый стиль отделки.'),
    ...
    },
    {
        ...
        metaTitle: localized('Custom furniture and apartment fit-out in Budva', 'Namještaj po mjeri Budva | Kuhinje po mjeri Budva', 'Мебель на заказ и меблировка квартир в Будве'),
        metaDescription: localized('ARTIDOM furnishes Budva apartments and rental properties with custom kitchens, wardrobes and built-in storage made in Zaljevo, Bar.', 'Namještaj po mjeri Budva: kuhinje po mjeri, plakari i ugradno odlaganje za apartmane i stanove za izdavanje, iz radionice u Zaljevu.', 'ARTIDOM меблирует квартиры и арендное жильё в Будве: кухни на заказ, шкафы и встроенное хранение из цеха в Залево (Бар).'),
    ...
    },
    {
        ...
        metaTitle: localized('Custom kitchen pricing and lead time in Montenegro', 'Kuhinje po mjeri cijena | Namještaj po mjeri Crna Gora', 'Стоимость кухни на заказ и сроки изготовления в Черногории'),
        ...
        focusItems: [
            ...
            localized('Front finish, fittings and worktop choice', 'Finiš frontova, okovi i izbor radne ploče', 'Отделка фасадов, фурнитура и выбор столешницы'),
